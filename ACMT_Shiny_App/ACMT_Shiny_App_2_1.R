                       ...
                       tabPanel('UPLOAD & GEOCODE', 
                                ...
                                navlistPanel(widths=c(3, 9),
                                             ...
                                             tabPanel('Geocode Data', 
                                                      ...
                                                      fluidRow(
                                                               h4(em('Summary of geocoding ratings:')),
                                                               ...
                                                               DT::dataTableOutput('ratingstable'), style = "padding-left: 30px; font-size: 80%; width: 50%")
                                                      # button to combine/rename address fields into one columns (may add this for a later iteration)
                                             ),
                                             ### Check ratings ####
                                             tabPanel(
                                               'Verify Geocodes & update address data',
                                               fluidRow(style='padding-left:30px',
                       ...
                       tabPanel('WALKABILITY', 
                                ...
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_walk', 'Select from available years of data', choices=walk_years, selected=walk_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                       ...
                       tabPanel('PLACES', 
                                ...
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_cdc', 'Select from available years of data', choices=cdc_years, selected=cdc_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                       ...
                       tabPanel('NLCD',
                                ...
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_nlcd', 'Select from available years of data', choices=nlcd_years, selected=nlcd_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                       ...
                       tabPanel('MRFEI', 
                                ...
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_mrfei', 'Select from available years of data', choices=mrfei_years, selected=mrfei_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                       ...
                       tabPanel("PARKSERVE", 
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_parks', 'Select from available years of data', choices=parks_years, selected=parks_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    selectizeInput('selectradii_parkserve', 
                                                                   label='Select or enter each radius of interest for interpolation buffers',
                                                                   choices = radiiDF$radius, 
                                                                   selected=NULL, 
                                                                   multiple = TRUE, 
                       ...
                       tabPanel('ACS', 
                                ...
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_acs', 'Select from available years of data', choices=acs_years, selected=acs_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                       ...
                       tabPanel('SIDEWALK', 
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_sidewalk', 'Select from available years of data', choices=sidewalk_years, selected=sidewalk_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    selectizeInput('selectradii_sidewalk', 
                                                                   label='Select or enter each radius of interest for interpolation buffers',
                                                                   choices = radiiDF$radius, 
                                                                   selected=NULL, 
                                                                   multiple = TRUE, 
                       ...
                       tabPanel('RPP', 
                                ...
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_rpp', 'Select from available years of data', choices=rpp_years, selected=rpp_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    selectizeInput('selectradii_rpp', 
                                                                   label='Select or enter each radius of interest for interpolation buffers',
                                                                   choices = radiiDF$radius, 
                                                                   selected=NULL, 
                                                                   multiple = TRUE, 
                       ...
                       tabPanel('GENTRIFICATION',
                                ...
                                sidebarPanel(
                                  ...
                                  fluidRow(style = 'padding:30px; padding-top:0px',
                                           h3('2. Select years and radii of interest'),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    checkboxGroupInput('selectyear_gentrification', 'Select from available years of data', choices=gentrification_years, selected=gentrification_selected_years, inline=TRUE)),
                                           tags$div(style='padding-left:30px', align='left', class='multicol', 
                                                    selectizeInput('selectradii_gentrification', 
                                                                   label='Select or enter each radius of interest for interpolation buffers',
                                                                   choices = radiiDF$radius, 
                                                                   selected=NULL, 
                                                                   multiple = TRUE, 
...
server<-function(input, output, session) {
  ...
  observeEvent(input$datafile, {
    if(input$upload_dataset == 'Participant id & address (no geocodes)'){
      ...
      saveData(data=data, fileName='dataset_address.csv')}
    if(input$upload_dataset == 'Geocoded participant data'){
      tryCatch({data<-filedata() %>% dplyr::select(id, lat, long) %>% mutate(address=NA, geocode_notes=NA)
      },
      error=function(e) {showNotification('Check dataset formatting and column names before uploading', type='error', id='status_notif', duration=NULL)
        return()}
      )
      saveData(data=data, fileName='dataset_geocoded.csv')
      filetable$data<-data%>%dplyr::select(id, lat, long)}
  })
