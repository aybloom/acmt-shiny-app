...
# ======= Check geocodes & update addresses =======================================
                                             tabPanel(
                                               ...
                                               fluidRow(style='padding-left:30px',
                                                        h5(strong('Update address errors to improve geocodes or use the mapping tool to verify & update geocodes manually'))
                                               ),
                                               fluidRow(style='padding-left:30px',
                                                        column(width=4,
                                                               h4("1. Load/Refresh geocoded data:"),
                                                               tags$ul(
                                                 ...
                                                 fluidRow(
                                                   column(width=4,
                                                          ...
                                                          wellPanel(
                                                            ...
                                                            em("If the lat/long is incorrect based on the map, start by updating the address itself (instructions below).")
                                                          ),
                                                          wellPanel(
                                                            h4("5. Update address:"), 
                                                            tags$ul(
                                                          ...
                                                          wellPanel(
                                                            h4("6. Update geocoding notes"), 
                                                            em("(only necessary when you can't get a rating to 0)"),
                                                   ...
                                                   column(width=8,
                                                          ...
                                                          wellPanel(
                                                            tags$h4("Manually update address location:"),
